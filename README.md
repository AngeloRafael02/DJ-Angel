...
Evolution
- Current Version: Optimized for Lavalink (v2.0+).
- Legacy Version: [v1.0-ffmpeg](https://github.com/AngeloRafael02/DJ-Angel/releases/tag/v1.0-ffmpeg) (Direct FFMPEG implementation).
---
...
3. Lavalink Configuration:
    - VM Deployment: Ensure the Lavalink jar is running on your host machine. It must also have [Lavalink](https://github.com/lavalink-devs/Lavalink) and [Java](https://www.java.com/en/download/) with the credentials put on the .env file.
...
## 🔒 Private Folder Setup
 DJ-Angel Bot also can use a private Google Drive folder but with additional steps:
...
## 📈 System Flow
You can view the architectural logic and data flow in our [LucidChart Diagram](https://lucid.app/lucidchart/f29097d4-c392-41ac-a090-356e71395e6d/edit?viewport_loc=-898%2C79%2C2934%2C1405%2C0_0&invitationId=inv_2b26c7e2-4c6d-42f9-8771-7ab5f85408cd).